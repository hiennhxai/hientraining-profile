import { Language, CourseItem, Article, ServiceItem, PhotoAlbumItem, BrandLogoItem, SocialLinkItem, ResourceItem } from '../types';
...
export const defaultResources: ResourceItem[] = [
  {
    id: 'res-1',
    title: 'Bộ Kịch Bản Livestream Chốt Đơn TikTok Shop 120 Phút (Chuẩn 4 Giai Đoạn)',
    description: 'Bao gồm kịch bản Hook 5 phút đầu, minh chứng sản phẩm Hero, voucher đếm ngược chốt đơn & câu thoại tháo gỡ băn khoăn khách hàng.',
    cat: 'script',
    fileType: 'PDF',
    fileUrl: 'https://raw.githubusercontent.com/hiennhxai/hientraining-profile/main/public/sample_script_tiktok.pdf',
    date: '2026.07.28',
    fileSize: '4.2 MB',
    tags: ['#TikTokShop', '#KichBan', '#Hot'],
    accessNote: 'Tài liệu dành cho học viên lớp Livestream Thực Chiến 1-1.'
  },
  {
    id: 'res-2',
    title: 'Bảng Tính Công Suất & Sơ Đồ Bố Trí Ánh Sáng Studio 3 Điểm (File Excel)',
    description: 'File Excel tự động tính toán Lux/Watt và khoảng cách đặt đèn Key Light, Fill Light, Backlight dựa trên diện tích phòng m2.',
    cat: 'template',
    fileType: 'XLSX',
    fileUrl: 'https://raw.githubusercontent.com/hiennhxai/hientraining-profile/main/public/sample_lighting_calc.xlsx',
    date: '2026.07.25',
    fileSize: '1.8 MB',
    tags: ['#Lighting', '#Studio', '#Excel'],
    accessNote: 'Đã tích hợp công thức sẵn. Chỉ cần nhập chiều dài và chiều rộng phòng.'
  },
  {
    id: 'res-3',
    title: 'Ebook Giáo Trình Luyện Khẩu Hình & Giọng Nói MC Chuyên Nghiệp (50 Trang)',
    description: 'Bộ bài tập ngáp vòm họng, nén hơi thở bụng, lip trill khởi động thanh đới và kỹ thuật phát âm chuẩn tròn trạ.',
    cat: 'ebook',
    fileType: 'PDF',
    fileUrl: 'https://raw.githubusercontent.com/hiennhxai/hientraining-profile/main/public/sample_voice_ebook.pdf',
    date: '2026.07.20',
    fileSize: '12.5 MB',
    tags: ['#MC', '#VoiceTalent', '#Ebook'],
    accessNote: 'Được biên soạn trực tiếp bởi MC Xuân Hiển (12+ năm kinh nghiệm TV).'
  },
  {
    id: 'res-4',
    title: 'File Cấu Hình Preset Scene OBS Studio 4K Multi-Cam (Giao Diện Pro)',
    description: 'File Zip cài đặt nhanh Lower-Thirds, Frame Banner nhãn hàng, Overlay chuyển cảnh 3 góc máy chuyên nghiệp.',
    cat: 'software',
    fileType: 'ZIP',
    fileUrl: 'https://raw.githubusercontent.com/hiennhxai/hientraining-profile/main/public/obs_preset_4k.zip',
    date: '2026.07.18',
    fileSize: '28.0 MB',
    tags: ['#OBS', '#MultiCam', '#Preset'],
    accessNote: 'Tương thích với OBS Studio phiên bản 29.0 trở lên.'
  },
  {
    id: 'res-5',
    title: 'Mẫu Kịch Bản Dẫn Chương Trình Gala Dinner & Launching Sản Phẩm Doanh Nghiệp',
    description: 'Mẫu Word kịch bản MC sự kiện chuyên nghiệp có phần dẫn mở đầu, khai mạc, trao giải & lời chào kết thúc.',
    cat: 'script',
    fileType: 'DOCX',
    fileUrl: 'https://raw.githubusercontent.com/hiennhxai/hientraining-profile/main/public/sample_event_mc.docx',
    date: '2026.07.15',
    fileSize: '850 KB',
    tags: ['#MCEvent', '#Word', '#SuKien'],
    accessNote: 'Có thể tùy chỉnh nhanh thông tin doanh nghiệp và danh sách VIP.'
  },
  {
    id: 'res-6',
    title: 'Checklist 25 Bước Kiểm Tra Thiết Bị & Đường Truyền Trước Phiên Live Stream',
    description: 'Bảng kiểm tra nhanh Micro, Camera, OBS, Soundcard, Ánh sáng & Băng thông Internet nhằm tránh sự cố kỹ thuật.',
    cat: 'setup_guide',
    fileType: 'PDF',
    fileUrl: 'https://raw.githubusercontent.com/hiennhxai/hientraining-profile/main/public/checklist_live_pro.pdf',
    date: '2026.07.10',
    fileSize: '2.1 MB',
    tags: ['#Checklist', '#Setup', '#PDF'],
    accessNote: 'In ra dán trước bàn kỹ thuật để kiểm tra trước mỗi phiên live.'
  },
  {
    id: 'res-7',
    title: 'Kho 500+ Nhạc Nền Livestream (BGM) Không Bản Quyền Phân Theo Nhịp Tim',
    description: 'Link Google Drive chứa thư viện âm thanh BGM sôi động, nhẹ nhàng, tạo kịch tính chốt đơn không lo đánh bản quyền.',
    cat: 'template',
    fileType: 'DRIVE',
    fileUrl: 'https://drive.google.com',
    date: '2026.07.05',
    fileSize: 'Google Drive',
    tags: ['#BGM', '#Drive', '#Music'],
    accessNote: 'Link Drive truy cập trực tiếp. Học viên có thể nghe thử trước khi tải.'
  },
  {
    id: 'res-8',
    title: 'Sơ Đồ Xử Lý Tiêu Âm & Cách Âm Phòng Thu Studio Chi Phí Tối Ưu',
    description: 'Bản vẽ bố trí mút trứng gà, bẫy bass trap góc tường, rèm tiêu âm và thảm sàn cho phòng diện tích từ 12-30m2.',
    cat: 'setup_guide',
    fileType: 'PDF',
    fileUrl: 'https://raw.githubusercontent.com/hiennhxai/hientraining-profile/main/public/acoustics_guide.pdf',
    date: '2026.07.01',
    fileSize: '3.5 MB',
    tags: ['#Audio', '#Acoustics', '#Setup'],
    accessNote: 'Giải pháp tiết kiệm 60% chi phí so với làm cách âm truyền thống.'
  }
];
