            ...
            <div className="space-y-4">
              {photos.filter(p => !!p.url).length === 0 ? (
                    ...
                    {filteredPhotos.map((photo) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            <img loading="lazy" decoding="async" src={photo.url} alt={photo.name} className="w-full h-full object-cover group-hover:scale-105 transition-transform cursor-pointer" />
                ...
                {isMultiSelect && selectedUrls.length > 0 && (
                  <div className="mt-4 p-3 bg-slate-900 rounded-xl flex items-center justify-between sticky bottom-0 z-10 border border-slate-700 shadow-2xl">
                    ...
                    <button aria-label="Action button" type="button"
                      ...
                      className="px-6 py-2 bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-500 hover:to-amber-500 text-white rounded-lg text-sm font-extrabold shadow-md shadow-orange-600/30 transition-all cursor-pointer"
                    >
                      XÁC NHẬN & LƯU LẠI
                    </button>
                  </div>
              ...
              {inputUrl && (
                <div className="p-3 bg-white rounded-xl border border-slate-200 text-center space-y-2">
                  ...
                  <div className="max-h-48 aspect-video mx-auto overflow-hidden rounded-lg bg-slate-900 flex items-center justify-center">
                    <img loading="lazy" decoding="async" src={inputUrl} alt="URL Preview" className="max-h-full max-w-full object-contain" />
                  </div>
                </div>
              )}
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {AI_MODELS.map((m) => {
                    ...
                    return (
                      <button aria-label="Action button" key={m.key}
                        type="button"
              ...
              {generatedAiImageUrl && (
                <div className="p-4 bg-white rounded-xl border border-purple-200 text-center space-y-3 mt-4">
                  ...
                  <div className="max-h-64 aspect-video mx-auto overflow-hidden rounded-lg bg-slate-100 flex items-center justify-center border border-slate-200 shadow-inner relative">
                    <img loading="lazy" decoding="async" src={generatedAiImageUrl} 
                      alt="AI Generated" 
            ...
            <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-1 bg-slate-950 p-1 rounded-xl border border-slate-800">
                      {(['16:9', '4:3', '1:1', '3:4', 'free'] as AspectRatioOption[]).map((ratio) => (
                        <button aria-label="Action button" key={ratio}
                          type="button"
                          onClick={() => {
              ...
              <div className="w-full max-h-[220px] sm:max-h-[280px] flex items-center justify-center bg-slate-950 p-2 sm:p-4 rounded-2xl border border-slate-800 overflow-hidden">
                ...
                >
                  ...
                  {cropImageUrl ? (
                    <img loading="lazy" decoding="async" src={cropImageUrl}
                      alt="Crop Viewport"
