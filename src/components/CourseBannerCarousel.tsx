  ...
  return (
    <div className="w-full my-2 sm:my-3 relative">
      ...
      >
        ...
        <button
          onClick={handlePrev}
          className="absolute left-3 top-1/2 -translate-y-1/2 p-2.5 sm:p-3 rounded-full bg-slate-900/80 border border-slate-700/80 text-slate-300 hover:text-white hover:bg-orange-600 hover:border-orange-500 transition-all shadow-lg cursor-pointer z-20 opacity-80 hover:opacity-100"
        ...
        <button
          onClick={handleNext}
          className="absolute right-3 top-1/2 -translate-y-1/2 p-2.5 sm:p-3 rounded-full bg-slate-900/80 border border-slate-700/80 text-slate-300 hover:text-white hover:bg-orange-600 hover:border-orange-500 transition-all shadow-lg cursor-pointer z-20 opacity-80 hover:opacity-100"
