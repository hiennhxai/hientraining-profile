      ...
      <div className="hero-in relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-left">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-center">
          ...
          <div className="lg:hidden flex justify-center mb-2">
            <div className="w-72 max-w-full px-4 sm:w-80 transition-transform hover:-translate-y-2 hover:scale-[1.02] duration-300">
          ...
          <div className="lg:col-span-8">
            ...
            {/* Main Headline */}
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 tracking-tight leading-tight mb-6 transition-all duration-300 hover:text-slate-800">
              <EditableWrapper
            ...
            <div className="flex flex-wrap items-center gap-2.5 mb-8 text-xs sm:text-sm text-slate-700 font-medium">
              <div className="flex items-center gap-2 bg-white/90 backdrop-blur-sm px-3.5 py-2 rounded-xl border border-orange-200 shadow-2xs text-slate-800 hover:shadow-md hover:-translate-y-1 transition-all duration-300 cursor-default">
                <Mic className="w-4 h-4 text-orange-600 animate-bounce" style={{animationDuration: '3s'}} />
            ...
            <div className="max-w-3xl">
              ...
              <div className="flex flex-wrap items-center gap-4 mb-8">
                <button aria-label="Action button" onClick={() => onNavigatePage ? onNavigatePage('courses') : window.location.href = '#courses'} 
                  className="relative overflow-hidden px-6 py-3.5 rounded-xl text-sm font-bold text-white bg-gradient-to-r from-orange-600 to-amber-500 hover:from-orange-500 hover:to-amber-400 transition-all duration-300 shadow-lg hover:shadow-orange-500/30 flex items-center gap-2 group cursor-pointer hover:-translate-y-1"
                >
                  <div className="absolute inset-0 bg-white/20 -skew-x-12 -translate-x-full group-hover:animate-[shimmer_1.5s_infinite]"></div>
                  <span className="relative z-10">{t.hero_btn1}</span>
                  <ChevronRight className="w-4 h-4 relative z-10 group-hover:translate-x-1 transition-transform" />
                </button>
                <a 
                  href="#contact"
                  className="px-6 py-3.5 rounded-xl text-sm font-bold text-slate-700 bg-white hover:bg-slate-50 transition-all duration-300 shadow-md border border-slate-200 flex items-center gap-2 group cursor-pointer hover:-translate-y-1 hover:shadow-lg"
                >
