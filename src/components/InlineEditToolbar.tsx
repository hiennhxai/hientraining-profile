    ...
    >
      ...
      {isCollapsed ? (
        <div className="flex items-center gap-2">
          <button aria-label="Action button" onClick={onToggleEditActive}
          ...
          <button aria-label="Action button" onClick={onOpenAdminPortal}
          ...
          <button aria-label="Action button" onClick={() => setIsCollapsed(false)}
        ...
        <>
          ...
          <button aria-label="Action button" onClick={onSaveAll}
            disabled={isSaving}
            className={`px-3 py-1.5 rounded-xl text-xs font-bold flex items-center gap-1.5 transition-all cursor-pointer shrink-0 ${
              isSaving
          ...
          <div className="flex items-center gap-1 pl-1 border-l border-slate-800 shrink-0">
            <button aria-label="Action button" onClick={dockTopRight}
            ...
            <button aria-label="Action button" onClick={dockBottomRight}
              className="p-1.5 rounded-xl bg-slate-800/80 hover:bg-slate-700 text-slate-400 hover:text-white transition-all cursor-pointer"
            ...
            {(position.x !== 0 || position.y !== 0) && (
              <button aria-label="Action button" onClick={dockTopCenter}
                className="p-1.5 rounded-xl bg-slate-800/80 hover:bg-slate-700 text-slate-400 hover:text-white transition-all cursor-pointer"
            ...
            <button aria-label="Action button" onClick={() => setIsCollapsed(true)}
              className="p-1.5 rounded-xl bg-slate-800/80 hover:bg-slate-700 text-slate-400 hover:text-white transition-all cursor-pointer"
          ...
          {/* Logout / Exit */}
          <button aria-label="Action button" onClick={onLogout}
