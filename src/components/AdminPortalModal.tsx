...
import { Article, CourseItem, ServiceItem, PhotoAlbumItem, BrandLogoItem, ArticleCategory, ResourceItem, ResourceCategory, ResourceFileType, LeadItem } from '../types';
...
import { 
  ...
  Eye, EyeOff, Smartphone, FolderDown, Wand2, Loader2, ArrowUp, ArrowDown, CloudOff, Cloud, Star, Users
} from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-2xl w-full max-w-7xl h-[94vh] flex flex-col overflow-hidden">
        ...
        <div className="px-6 py-4 bg-slate-950 text-white flex items-center justify-between border-b border-slate-800 shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <button aria-label="Action button" onClick={() => handleSave(false)}
        ...
        <div className="bg-slate-100 p-2.5 border-b border-slate-200 space-y-2 shrink-0">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-6 gap-2">
            <button aria-label="Action button" onClick={() => { setActiveTab('general'); setEditingArticleSlug(null); }}
            ...
            <button aria-label="Action button" onClick={() => { setActiveTab('brands'); setEditingArticleSlug(null); }}
              className={`px-3 py-2 rounded-xl text-xs font-bold flex items-center justify-center gap-2 transition-all cursor-pointer ${
            ...
            <button aria-label="Action button" onClick={() => { setActiveTab('story'); setEditingArticleSlug(null); }}
              className={`px-3 py-2 rounded-xl text-xs font-bold flex items-center justify-center gap-2 transition-all cursor-pointer ${
            ...
            <button aria-label="Action button" onClick={() => { setActiveTab('courses'); setEditingArticleSlug(null); }}
              className={`px-3 py-2 rounded-xl text-xs font-bold flex items-center justify-center gap-2 transition-all cursor-pointer ${
            ...
            <button aria-label="Action button" onClick={() => { setActiveTab('resources'); setEditingArticleSlug(null); }}
              className={`px-3 py-2 rounded-xl text-xs font-bold flex items-center justify-center gap-2 transition-all cursor-pointer ${
            ...
            <button aria-label="Action button" onClick={() => { setActiveTab('leads'); setEditingArticleSlug(null); }}
              className={`px-3 py-2 rounded-xl text-xs font-bold flex items-center justify-center gap-2 transition-all cursor-pointer ${
                activeTab === 'leads' ? 'bg-cyan-600 text-white shadow-md' : 'bg-cyan-50 text-cyan-900 hover:bg-cyan-100 border border-cyan-200'
              }`}
            >
          ...
          {/* Row 2: Services, Projects & TikTok, Blog Articles, Testimonials */}
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-2">
            <button aria-label="Action button" onClick={() => { setActiveTab('testimonials'); setEditingArticleSlug(null); }}
              className={`px-3 py-2 rounded-xl text-xs font-bold flex items-center justify-center gap-2 transition-all cursor-pointer ${
                activeTab === 'testimonials' ? 'bg-orange-600 text-white shadow-md' : 'bg-emerald-50 text-emerald-900 hover:bg-emerald-100 border border-emerald-200'
              }`}
            >
              <Sparkles className="w-4 h-4 shrink-0 text-emerald-500" />
              <span className="truncate">⭐ Testimonials ({(data.testimonials || []).length})</span>
            </button>
            <button aria-label="Action button" onClick={() => { setActiveTab('services'); setEditingArticleSlug(null); }}
              className={`px-3 py-2 rounded-xl text-xs font-bold flex items-center justify-center gap-2 transition-all cursor-pointer ${
            ...
            <button aria-label="Action button" onClick={() => { setActiveTab('projects'); setEditingArticleSlug(null); }}
              className={`px-3 py-2 rounded-xl text-xs font-bold flex items-center justify-center gap-2 transition-all cursor-pointer ${
            ...
            <button aria-label="Action button" onClick={() => setActiveTab('articles')}
              className={`px-3 py-2 rounded-xl text-xs font-bold flex items-center justify-center gap-2 transition-all cursor-pointer ${
            ...
            <button aria-label="Action button" onClick={() => { setActiveTab('album'); setEditingArticleSlug(null); }}
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-slate-50">
                  ...
                  <div className="lg:col-span-5 p-3 rounded-2xl bg-slate-950 text-white border border-slate-800 shadow-xl space-y-2">
                    ...
                    <div className="relative aspect-[4/5] bg-gradient-to-b from-orange-950/40 via-slate-900 to-slate-950 rounded-xl overflow-hidden flex items-center justify-center border border-slate-800/80">
                      ...
                      <div className="relative w-full h-full overflow-hidden">
                        <img loading="lazy" decoding="async" src={data.general.heroPortraitUrl || ""} 
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  {(data.general.aboutTrainingImages || []).map((imgUrl, imgIdx) => (
                    <div key={imgIdx} className="relative aspect-video rounded-lg overflow-hidden group border border-slate-200 shadow-sm">
                      <img loading="lazy" decoding="async" src={imgUrl} alt={`Training ${imgIdx}`} className="w-full h-full object-cover" />
          ...
          {activeTab === 'projects' && (
            <div className="space-y-8">
              <div className="p-4 bg-orange-50 rounded-2xl border border-orange-200 text-xs text-orange-900 font-medium flex flex-col md:flex-row md:items-center justify-between gap-3">
                <div className="flex items-center gap-2">
                  <Sparkles className="w-5 h-5 text-orange-600 shrink-0" />
                  <span>
                    <strong>QUẢN LÝ DỰ ÁN DẠNG LƯỚI 4 CỘT (CÁC HẠNG MỤC CHÍNH)</strong>: Mỗi dự án có thể dán link video, tùy chỉnh ảnh đại diện 16:9 và đính kèm <strong>Album ảnh thực tế</strong> để xem Pop-up!
                  </span>
                </div>
                <button aria-label="Action button" type="button"
                  onClick={() => {
                    const newCategory = {
                      id: `cat-${Date.now()}`,
                      title: 'HẠNG MỤC DỰ ÁN MỚI',
                      description: 'Mô tả ngắn gọn về hạng mục dự án này.',
                      items: []
                    };
                    setData({ ...data, projects: [...(data.projects || []), newCategory] });
                  }}
                  className="px-4 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-extrabold text-xs flex items-center gap-1.5 shadow-md cursor-pointer transition-all shrink-0"
                >
                  <Plus className="w-4 h-4" />
                  <span>Thêm Hạng Mục Dự Án Tổng</span>
                </button>
              </div>

              {/* ITERATE OVER ALL PROJECT CATEGORIES */}
                ...
                <div key={cat.id || catIdx} className="p-5 bg-white rounded-2xl border border-slate-200 shadow-xs space-y-4">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-100 pb-3">
                    <div className="flex-1 space-y-2">
                      <div className="flex items-center gap-2">
                        <FolderGit2 className="w-4 h-4 text-orange-600 shrink-0" />
                        <span className="font-mono text-[10px] font-bold text-orange-600 bg-orange-50 px-1.5 py-0.5 rounded border border-orange-200 shrink-0">#{catIdx + 1}</span>
                        <input
                          type="text"
                          value={cat.title}
                          onChange={(e) => {
                            const newProjects = [...(data.projects || [])];
                            newProjects[catIdx].title = e.target.value;
                            setData({ ...data, projects: newProjects });
                          }}
                          className="font-extrabold text-sm text-slate-900 bg-transparent border-b border-slate-300 px-1 py-0.5 flex-1 min-w-0"
                          placeholder="Tên Hạng Mục (VD: Kênh TikTok Học Viên)"
                        />
                      </div>
                      <input
                        type="text"
                        ...
                        onChange={(e) => {
                          const newProjects = [...(data.projects || [])];
                          newProjects[catIdx].description = e.target.value;
                          setData({ ...data, projects: newProjects });
                        }}
                        className="w-full text-xs text-slate-600 font-medium bg-transparent border-b border-slate-200 px-1 py-0.5 focus:border-orange-400 focus:outline-none transition-colors"
                        placeholder="Mô tả hạng mục dự án..."
                      />
                    </div>
                    <div className="flex items-center gap-2 shrink-0">
                      <button aria-label="Action button" type="button"
                        onClick={() => {
                          const newProjects = [...(data.projects || [])];
                          if (catIdx > 0) {
                            [newProjects[catIdx - 1], newProjects[catIdx]] = [newProjects[catIdx], newProjects[catIdx - 1]];
                            setData({ ...data, projects: newProjects });
                          }
                        }}
                        className="p-1.5 rounded-lg bg-slate-50 hover:bg-slate-100 text-slate-600 transition-colors cursor-pointer"
                        title="Di chuyển hạng mục lên"
                      >
                        <ChevronUp className="w-4 h-4" />
                      </button>
                      <button aria-label="Action button" type="button"
                        onClick={() => {
                          const newProjects = [...(data.projects || [])];
                          if (catIdx < newProjects.length - 1) {
                            [newProjects[catIdx + 1], newProjects[catIdx]] = [newProjects[catIdx], newProjects[catIdx + 1]];
                            setData({ ...data, projects: newProjects });
                          }
                        }}
                        className="p-1.5 rounded-lg bg-slate-50 hover:bg-slate-100 text-slate-600 transition-colors cursor-pointer"
                        title="Di chuyển hạng mục xuống"
                      >
                        <ChevronDown className="w-4 h-4" />
                      </button>
                      <button aria-label="Action button" type="button"
                        onClick={() => {
                          if (window.confirm(`Bạn có chắc chắn muốn xóa TOÀN BỘ hạng mục "${cat.title}" cùng ${cat.items.length} dự án con bên trong không?`)) {
                            const newProjects = [...(data.projects || [])];
                            newProjects.splice(catIdx, 1);
                            setData({ ...data, projects: newProjects });
                          }
                        }}
                        className="px-3 py-1.5 rounded-lg bg-red-50 hover:bg-red-100 text-red-600 text-[11px] font-bold flex items-center gap-1 cursor-pointer transition-colors"
                        title="Xóa toàn bộ hạng mục này"
                      >
                        <Trash2 className="w-3.5 h-3.5" />
                        <span>Xóa Hạng Mục Này</span>
                      </button>
                      <button aria-label="Action button" type="button"
                        onClick={() => {
                          const newItem = {
                          ...
                          newProjects[catIdx] = {
                            ...newProjects[catIdx],
                            items: [...newProjects[catIdx].items, newItem]
                          };
                          setData({ ...data, projects: newProjects });
                        }}
                        className="px-3.5 py-1.5 rounded-xl bg-orange-600 hover:bg-orange-500 text-white text-[11px] font-bold flex items-center gap-1.5 shadow-md cursor-pointer transition-all"
                      >
                        <Plus className="w-3.5 h-3.5" />
                      ...
                      >
                        <div className="space-y-2.5">
                          ...
                          <div className="relative aspect-video w-full rounded-lg bg-slate-900 border border-slate-200 overflow-hidden group/img">
                            {item.thumbnailUrl ? (
                              <img loading="lazy" decoding="async" src={item.thumbnailUrl} alt={item.title} className="w-full h-full object-cover" />
                            ) : (
                              <div className="w-full h-full flex items-center justify-center text-[10px] font-mono text-slate-400 font-bold">
                                Chưa có ảnh 16:9
                              </div>
                            )}
                            <div className="absolute inset-0 bg-slate-900/80 backdrop-blur-xs opacity-0 group-hover/img:opacity-100 flex flex-col items-center justify-center gap-2 transition-opacity">
                              <button aria-label="Action button" type="button"
                                onClick={() => openPicker(
                                  (selectedUrl) => {
                                    const newProjects = [...(data.projects || [])];
                                    newProjects[catIdx] = {
                                      ...newProjects[catIdx],
                                      items: newProjects[catIdx].items.map((it, i) => i === itemIdx ? { ...it, thumbnailUrl: selectedUrl } : it)
                                    };
                                    setData({ ...data, projects: newProjects });
                                  },
                                ...
                                className="text-white text-[10px] font-extrabold cursor-pointer hover:text-orange-400"
                              >
                              ...
                              {item.thumbnailUrl && (
                                <button aria-label="Action button" type="button"
                                  onClick={() => {
                                    if (window.confirm("Bạn có chắc muốn xóa ảnh thumbnail này?")) {
                                      const newProjects = [...(data.projects || [])];
                                      newProjects[catIdx] = {
                                        ...newProjects[catIdx],
                                        items: newProjects[catIdx].items.map((it, i) => i === itemIdx ? { ...it, thumbnailUrl: '' } : it)
                                      };
                                      setData({ ...data, projects: newProjects });
                                    }
                                  }}
                                  className="text-red-400 hover:text-red-500 text-[10px] font-extrabold cursor-pointer flex items-center gap-1"
                                >
                                  🗑️ Xóa Ảnh
                                </button>
                              )}
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                ...
                                newProjects[catIdx] = {
                                  ...newProjects[catIdx],
                                  items: newProjects[catIdx].items.map((it, i) => i === itemIdx ? { ...it, title: e.target.value } : it)
                                };
                                setData({ ...data, projects: newProjects });
                              }}
                            ...
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => {
                                  ...
                                  newProjects[catIdx] = {
                                    ...newProjects[catIdx],
                                    items: newProjects[catIdx].items.map((it, i) => i === itemIdx ? { ...it, role: e.target.value } : it)
                                  };
                                  setData({ ...data, projects: newProjects });
                                }}
                            ...
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => {
                                  ...
                                  newProjects[catIdx] = {
                                    ...newProjects[catIdx],
                                    items: newProjects[catIdx].items.map((it, i) => i === itemIdx ? { ...it, stats: e.target.value } : it)
                                  };
                                  setData({ ...data, projects: newProjects });
                                }}
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                ...
                                newProjects[catIdx] = {
                                  ...newProjects[catIdx],
                                  items: newProjects[catIdx].items.map((it, i) => i === itemIdx ? { ...it, url: e.target.value } : it)
                                };
                                setData({ ...data, projects: newProjects });
                              }}
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              onChange={(e) => {
                                ...
                                newProjects[catIdx] = {
                                  ...newProjects[catIdx],
                                  items: newProjects[catIdx].items.map((it, i) => i === itemIdx ? { ...it, description: e.target.value } : it)
                                };
                                setData({ ...data, projects: newProjects });
                              }}
                              ...
                              <button aria-label="Action button" type="button"
                                onClick={() => openPicker(
                                  (selectedUrl) => {
                                    ...
                                    newProjects[catIdx] = {
                                      ...newProjects[catIdx],
                                      items: newProjects[catIdx].items.map((it, i) => i === itemIdx ? { ...it, galleryPhotos: [...currentGallery, selectedUrl] } : it)
                                    };
                                    setData({ ...data, projects: newProjects });
                                  },
                                  ...
                                  (selectedUrls) => {
                                    ...
                                    newProjects[catIdx] = {
                                      ...newProjects[catIdx],
                                      items: newProjects[catIdx].items.map((it, i) => i === itemIdx ? { ...it, galleryPhotos: [...currentGallery, ...selectedUrls] } : it)
                                    };
                                    setData({ ...data, projects: newProjects });
                                  }
                                )}
                            ...
                            <div className="flex flex-wrap gap-1.5 max-h-24 overflow-y-auto">
                              {(item.galleryPhotos || []).map((imgUrl, gIdx) => (
                                <div key={gIdx} className="relative w-10 h-10 rounded-md overflow-hidden bg-slate-800 border border-slate-300 group/gal">
                                  <img loading="lazy" decoding="async" src={imgUrl} alt={`Album ${gIdx}`} className="w-full h-full object-cover" />
                                  <button aria-label="Action button" type="button"
                                    onClick={() => {
                                      const newProjects = [...(data.projects || [])];
                                      const currentGallery = newProjects[catIdx].items[itemIdx].galleryPhotos || [];
                                      newProjects[catIdx] = {
                                        ...newProjects[catIdx],
                                        items: newProjects[catIdx].items.map((it, i) => i === itemIdx ? { ...it, galleryPhotos: currentGallery.filter((_, g) => g !== gIdx) } : it)
                                      };
                                      setData({ ...data, projects: newProjects });
                                    }}
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-slate-200">
                          <div className="flex items-center gap-1">
                            <span className="text-[10px] font-mono text-slate-400 mr-2">#{itemIdx + 1}</span>
                            <button aria-label="Action button" type="button"
                              onClick={() => {
                                const newProjects = [...(data.projects || [])];
                                const items = [...newProjects[catIdx].items];
                                if (itemIdx > 0) {
                                  [items[itemIdx - 1], items[itemIdx]] = [items[itemIdx], items[itemIdx - 1]];
                                  newProjects[catIdx] = { ...newProjects[catIdx], items };
                                  setData({ ...data, projects: newProjects });
                                }
                              }}
                          ...
                          <button aria-label="Action button" type="button"
                            onClick={() => {
                              if (window.confirm(`Xóa dự án "${item.title}"?`)) {
                                ...
                                newProjects[catIdx] = {
                                  ...newProjects[catIdx],
                                  items: newProjects[catIdx].items.filter((_, i) => i !== itemIdx)
                                };
                                setData({ ...data, projects: newProjects });
                              }
                            }}
                  ...
                  {(data.brandLogos || []).map((brand, bIdx) => (
                    ...
                    >
                      ...
                      <div className="relative aspect-video w-full rounded-lg bg-slate-900 border border-slate-200 flex items-center justify-center p-1.5 overflow-hidden group/img">
                        {brand.logoUrl ? (
                          <img loading="lazy" decoding="async" src={brand.logoUrl} alt={brand.name} className="max-h-full max-w-full object-contain mx-auto my-auto" />
                        ) : (
            ...
            <div className="space-y-6 animate-fadeIn">
              <div className="flex items-center justify-between pb-4 border-b border-slate-200">
                <div>
                  <h3 className="text-lg font-extrabold text-slate-800 flex items-center gap-2">
                    ...
                    Quản Lý Lời Chứng Thực (Testimonials)
                  </h3>
                  <p className="text-slate-500 text-xs font-medium mt-1">Đánh giá và lời khen từ học viên, đối tác để tăng uy tín.</p>
                </div>
                <button aria-label="Action button" onClick={() => {
                    const newItem = {
                      id: `t-${Date.now()}`,
                      name: 'Tên Học Viên',
                      role: 'Học viên / Chức vụ',
                  ...
                  className="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs flex items-center gap-2 transition-colors cursor-pointer shadow-sm"
                >
                  <Plus className="w-4 h-4" />
                  Thêm Đánh Giá Mới
                </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {(data.testimonials || []).map((t, idx) => (
                  <div key={t.id} className="p-4 rounded-2xl bg-white border border-slate-200 shadow-sm relative group space-y-4">
                    <button aria-label="Action button" onClick={() => {
                        if(window.confirm('Xóa lời chứng thực này?')) {
                          const list = [...(data.testimonials || [])];
                          list.splice(idx, 1);
                          setData({ ...data, testimonials: list });
                        }
                      }}
                      className="absolute top-4 right-4 p-1.5 rounded-lg bg-red-50 text-red-500 hover:bg-red-500 hover:text-white transition-colors cursor-pointer"
                      title="Xóa đánh giá"
                    >
                      <Trash2 className="w-4 h-4" />
                    </button>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex flex-col items-center gap-2">
                        <div 
                          className="w-16 h-16 rounded-full bg-slate-100 border border-slate-200 overflow-hidden flex items-center justify-center cursor-pointer hover:ring-2 hover:ring-emerald-500 transition-all shrink-0 group/avatar relative"
                          onClick={() => {
                            openPicker((url) => {
                              const list = [...(data.testimonials || [])];
                              list[idx] = { ...list[idx], avatarUrl: url };
                              setData({ ...data, testimonials: list });
                            }, 'CHỌN ẢNH ĐẠI DIỆN HỌC VIÊN', t.avatarUrl || '');
                          }}
                        >
                          {t.avatarUrl ? (
                            <img loading="lazy" decoding="async" src={t.avatarUrl} alt="Avatar" className="w-full h-full object-cover" />
                          ) : (
                        ...
                        <span className="text-[10px] text-slate-500 font-medium">Avatar</span>
                      </div>

                      <div className="flex-1 space-y-3">
                        <div>
                          <label className="text-[10px] font-mono font-bold text-slate-500 mb-1 block">TÊN NGƯỜI ĐÁNH GIÁ</label>
                          <input
                            type="text"
                            value={t.name}
                            onChange={(e) => {
                            ...
                            className="w-full px-3 py-1.5 rounded-lg bg-slate-50 border border-slate-200 text-slate-900 text-sm font-bold focus:bg-white focus:ring-2 focus:ring-emerald-500/20"
                          />
                        </div>
                        <div>
                          <label className="text-[10px] font-mono font-bold text-slate-500 mb-1 block">CHỨC VỤ / LỚP HỌC</label>
                          <input
                            type="text"
                            value={t.role}
                            onChange={(e) => {
                            ...
                            className="w-full px-3 py-1.5 rounded-lg bg-slate-50 border border-slate-200 text-emerald-600 text-xs font-semibold focus:bg-white focus:ring-2 focus:ring-emerald-500/20"
                          />
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      <label className="text-[10px] font-mono font-bold text-slate-500 mb-1 block">NỘI DUNG LỜI KHEN (CẢM NHẬN)</label>
                      <textarea
                        rows={4}
                        value={t.content}
                        onChange={(e) => {
                        ...
                        className="w-full px-3 py-2 rounded-xl bg-slate-50 border border-slate-200 text-slate-700 text-sm font-medium focus:bg-white focus:ring-2 focus:ring-emerald-500/20 italic"
                      />
                    </div>
                  </div>
                ))}
              ...
              {(!data.testimonials || data.testimonials.length === 0) && (
                <div className="text-center py-12 bg-slate-50 rounded-2xl border border-dashed border-slate-300">
                  ...
                  <h4 className="text-slate-500 font-bold">Chưa có lời chứng thực nào</h4>
                  <p className="text-slate-400 text-xs mt-1">Bấm "Thêm Đánh Giá Mới" để bắt đầu cập nhật Feedback.</p>
                </div>
              )}
            </div>
          )}
          ...
          {activeTab === 'leads' && (
            <div className="space-y-8 animate-fade-in-up">
              <div className="bg-white rounded-2xl shadow-sm border border-cyan-100 overflow-hidden">
                <div className="p-4 sm:p-6 border-b border-cyan-100 flex flex-col sm:flex-row items-center justify-between gap-4">
                  <div>
                    <h3 className="text-lg font-bold text-cyan-900 flex items-center gap-2">
                      <Users className="w-5 h-5 text-cyan-600" />
                      Danh Sách Khách Hàng (Leads)
                    </h3>
                    <p className="text-xs text-cyan-700 mt-1">Danh sách data khách hàng điền form tải Kho Tài Liệu.</p>
                  </div>
                  <button aria-label="Action button" type="button"
                    onClick={() => {
                      ...
                      const headers = ['Họ Tên', 'Số Điện Thoại', 'Email', 'Nguồn (Tài Liệu)', 'Ngày Đăng Ký'];
                      const csvContent = [
                        headers.join(','),
                      ...
                      link.href = url;
                      link.setAttribute('download', `Leads_KhoTaiLieu_${new Date().toISOString().slice(0,10)}.csv`);
                ...
                <div className="p-4 sm:p-6">
                  {isLoadingLeads ? (
                    <div className="text-center py-8 text-cyan-600 font-medium">Đang tải danh sách khách hàng...</div>
                  ) : (!fetchedLeads || fetchedLeads.length === 0) ? (
                    <div className="text-center py-8 text-cyan-600 font-medium bg-cyan-50 rounded-xl border border-dashed border-cyan-200">
                      Chưa có khách hàng nào đăng ký tải tài liệu.
                    </div>
                  ) : (
                    <div className="overflow-x-auto rounded-xl border border-cyan-100">
                      <table className="min-w-full divide-y divide-cyan-200">
                        <thead className="bg-cyan-50">
                          <tr>
                            <th scope="col" className="px-6 py-3 text-left text-xs font-bold text-cyan-800 uppercase tracking-wider">Họ Tên</th>
                            <th scope="col" className="px-6 py-3 text-left text-xs font-bold text-cyan-800 uppercase tracking-wider">Số Điện Thoại</th>
                            <th scope="col" className="px-6 py-3 text-left text-xs font-bold text-cyan-800 uppercase tracking-wider">Email</th>
                            <th scope="col" className="px-6 py-3 text-left text-xs font-bold text-cyan-800 uppercase tracking-wider">Tài Liệu Tải</th>
                            <th scope="col" className="px-6 py-3 text-left text-xs font-bold text-cyan-800 uppercase tracking-wider">Thời Gian</th>
                          </tr>
                        </thead>
                        <tbody className="bg-white divide-y divide-cyan-100">
                          {fetchedLeads.map((lead) => (
                            <tr key={lead.id} className="hover:bg-cyan-50/50 transition-colors">
                              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-slate-900">{lead.name}</td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-600 font-mono">{lead.phone}</td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-600">{lead.email || '-'}</td>
                              <td className="px-6 py-4 text-sm text-slate-600 max-w-xs truncate" title={lead.source}>{lead.source}</td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-500">{new Date(lead.createdAt).toLocaleString('vi-VN')}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
