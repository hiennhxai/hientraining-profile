    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              // Scripts: Chỉ cho phép từ chính web, Google (Analytics/Tag/reCAPTCHA), Facebook Pixel
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://connect.facebook.net https://translate.google.com https://translate.googleapis.com https://www.google.com https://www.gstatic.com",
